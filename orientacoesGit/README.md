# Orientações - Prova Recuperação [27/09/2022 - 15:30 até 17:00]
...
```html
https://github.com/ldmfabio/1INFO2_itsc_provaRec.git
```
*Ou então*, no terminal do VSCode, digite:
```GIT
git clone https://github.com/ldmfabio/1INFO2_itsc_provaRec.git
```
